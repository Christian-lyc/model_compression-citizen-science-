...
path='/export/data/yliu/robotflow/test/images'
path_label='/export/data/yliu/robotflow/test/labels'
model = YOLO('/export/home/yliu/runs/detect/train2/weights/best.pt')

model_pruned = '/export/home/yliu/object_detection/str_unstr_pruning/finetune/str_unstr_pruning40_remove/weights/best.onnx' #'/export/home/yliu/runs/detect/train2/weights/best.onnx'
...
#print('MACs for ONNX model:',onnx_macs)
...
#tmpfile='best.onnx'
#with torch.no_grad():
    #torch_out = torch.onnx.export(model_pruned, x, tmpfile, opset_version=12)
#    onnx_tool.model_profile(tmpfile,None, None)
precision1=0
recall1=0
tracker.start()
